...
<body>
    ...
    <div class="d-flex justify-content-between">
        <div class="justify-content-left">
            <p class="fs-4 ms-4">
                <b>{{$message->institute->institute_name}}</b> Message
            </p>
        </div>
    ...
    <div class="d-flex justify-content-between mb-3">
        <nav aria-label="breadcrumb">
            <ol class="ms-4 breadcrumb">
              <li class="breadcrumb-item">
                <a href="{{ route('superAdmin.allmessages.view') }}">Manage Tasks</a>
              </li>
              <li class="breadcrumb-item active" aria-current="page">{{$message->institute->institute_name}} Message</li>
            </ol>
        </nav>
        ...
        <form action="{{ route('update.message.priority', $message->id) }}" method="POST">
            ...
            <div class="dropdown-center me-2">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item badge top-urgent" href="#" onclick="changePriority('Top Urgent')">Top Urgent (2 min)</a></li>
                    <li><a class="dropdown-item badge urgent" href="#" onclick="changePriority('Urgent')">Urgent (5 min)</a></li>
                    <li><a class="dropdown-item badge medium" href="#" onclick="changePriority('Medium')">Medium (2 hrs)</a></li>
                    <li><a class="dropdown-item badge low" href="#" onclick="changePriority('Low')">Low (1 day)</a></li>
                </ul>
            </div>
        </form>
        ...
        <form action="{{ route('update.message.status', $message->id) }}" method="POST" id="statusForm">
            ...
            <div class="dropdown-center">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item badge in-queue" href="#" onclick="changeStatus('In Queue')">In Queue</a></li>
                    <li><a class="dropdown-item badge in-progress" href="#" onclick="changeStatus('In Progress')">In Progress</a></li>
                    <li><a class="dropdown-item badge document-pending" href="#" onclick="openProgressModal('Document Pending')">Document Pending</a></li>
                    <li><a class="dropdown-item badge postponed" href="#" onclick="openProgressModal('Postponed')">Postponed</a></li>
                    <li><a class="dropdown-item badge move-next-day" href="#" onclick="openProgressModal('Move to next day')">Move to next day</a></li>
                    <li><a class="dropdown-item badge complete-next-day" href="#" onclick="openProgressModal('Complete in next day')">Complete in next day</a></li>
                    <li><a class="dropdown-item badge completed" href="#" onclick="changeStatus('Completed')">Completed</a></li>
                </ul>
            </div>
        </form>
    ...
    <section class="container">
        ...
        <div class="modal fade" id="editProgressNoteModal" tabindex="-1" aria-labelledby="editProgressNoteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <form id="editProgressNoteForm" action="{{ route('update.progress.note', $message->id) }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="submitEditProgressNoteForm()">Save Changes</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-3 mb-2 bg-primary-subtle text-secondary-emphasis problemImageMainBG rounded">
            <div class="row d-flex justify-content-center mx-auto">
                <div class="col-md-2 p-2">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_1) }}" alt="empty" class="img-thumbnail problemImage ionHover" data-toggle="modal" data-target="#imageModal1">
                </div>
                <div class="col-md-2 p-2">
                    <img src="{{ asset('images/MessageWithProblem/'.$message->img_2) }}" alt="empty" class="img-thumbnail problemImage ionHover" data-toggle="modal" data-target="#imageModal2">
                </div>
                <div class="col-md-2 p-2">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_3) }}" alt="empty" class="img-thumbnail problemImage ionHover" data-toggle="modal" data-target="#imageModal3">
                </div>
                <div class="col-md-2 p-2">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_4) }}" alt="empty" class="img-thumbnail problemImage ionHover" data-toggle="modal" data-target="#imageModal4">
                </div>
                <div class="col-md-2 p-2">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_5) }}" alt="empty" class="img-thumbnail problemImage ionHover" data-toggle="modal" data-target="#imageModal5">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="imageModal1" tabindex="-1" aria-labelledby="imageModalLabel1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
              <div class="modal-body">
                  <img src="{{ asset('images/MessageWithProblem/'.$message-> img_1) }}" alt="Full Image 1" class="img-fluid">
              </div>
              <div class="modal-footer">
    ...
    <div class="modal fade" id="imageModal2" tabindex="-1" aria-labelledby="imageModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_2) }}" alt="Full Image 2" class="img-fluid">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
    ...
    <div class="modal fade" id="imageModal3" tabindex="-1" aria-labelledby="imageModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{ asset('images/MessageWithProblem/'.$message-> img_3) }}" alt="Full Image 3" class="img-fluid">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              </div>
    ...
    <div class="modal fade" id="imageModal4" tabindex="-1" aria-labelledby="imageModalLabel4" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
              <div class="modal-body">
                  <img src="{{ asset('images/MessageWithProblem/'.$message-> img_4) }}" alt="Full Image 4" class="img-fluid">
              </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              </div>
    ...
    <div class="modal fade" id="imageModal5" tabindex="-1" aria-labelledby="imageModalLabel5" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
              <div class="modal-body">
                  <img src="{{ asset('images/MessageWithProblem/'.$message-> img_5) }}" alt="Full Image 5" class="img-fluid">
              </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              </div>

...
@section('SuperAdminContent')
    ...
    <div class="mt-4">
        <!-- Filter Section -->
        <div class="mt-3">
            <form action="{{ route('superAdmin.allmessages.view') }}" method="GET">
                <div class="row mb-3 align-items-end">
                    {{-- Filter from the employee name --}}
                    <div class="col-md-3 mb-2 mb-md-0">
                        <label for="assigned_employee">Enter Employee Name:</label>
                        <input type="text" name="assigned_employee" class="form-control"
                    ...
                    <div class="col-md-3 mb-2 mb-md-0">
                        ...
                        <select name="priority" class="form-select">
                            ...
                            <option value="Top Urgent" {{ request()->priority == 'Top Urgent' ? 'selected' : '' }}>Top
                                Urgent</option>
                    ...
                    <div class="col-md-3 mb-2 mb-md-0">
                        ...
                        <select name="progress" class="form-select">
                            ...
                            <option value="Document Pending"
                                {{ request()->progress == 'Document Pending' ? 'selected' : '' }}>
                                Document Pending
                            </option>
                            <option value="Postponed" {{ request()->progress == 'Postponed' ? 'selected' : '' }}>
                                Postponed
                            </option>
                            <option value="Move to Next Day"
                                {{ request()->progress == 'Move to Next Day' ? 'selected' : '' }}>
                                Move to Next Day
                            </option>
                            <option value="Complete in Next Day"
                                {{ request()->progress == 'Complete in Next Day' ? 'selected' : '' }}>Complete in Next
                                Day
                            </option>
                            <option value="Completed" {{ request()->progress == 'Completed' ? 'selected' : '' }}>
                                Completed
                            </option>
                        </select>
                    </div>
                        ...
                        <div class="col-md-8">
                            <form action="{{ route('superAdmin.messages.save') }}" method="post"
                                ...
                                <div class="form-floating userBgShado">
                                    <textarea class="form-control" name="message" value="{{ old('message') }}" placeholder="Message"

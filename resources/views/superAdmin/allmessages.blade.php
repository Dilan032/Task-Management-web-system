    ...
    <section class="px-4 mb-4">
        ...
        <section class="px-4 mb-4">
            <form action="{{ route('superAdmin.allmessages.view') }}" method="GET" class="form-inline row">
                ...
                <!-- Buttons Section -->
                <div class="col-md-3 d-flex justify-content-end align-items-center" style="margin-top:17px">
                    <button type="submit" class="btn btn-primary me-2">Apply</button>
                    <a href="{{ route('superAdmin.allmessages.view') }}" class="btn btn-warning me-2">Reset</a>
                    <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop2"
